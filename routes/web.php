...
Route::middleware(['penumpang'])->group(function () {
    ...
    Route::get('/penumpang/create/{data}', [PenumpangController::class, 'edit'])->name('penumpang.edit');
...
Route::get('/data-penumpang', [PenumpangController::class, 'dataPenumpang'])->name('dataPenumpang');
